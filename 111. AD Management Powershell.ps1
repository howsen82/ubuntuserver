...
$Forestwide = (Get-ADForest).Domains | ForEach-Object { Get-ADDomainController -Filter * -Server $_ } Write-Output $Forestwide -Filter * | Select-Object Name,Forest,Domain,IPv4Address,Site

$Forestwide = (Get-ADForest).Domains | ForEach-Object { Get-ADDomainController -Filter * -Server $_ }
$Forestwide | Select-Object Name,Forest,Domain,IPv4Address,Site

## List rodc ##
$Domain = Read-Host 'What is your Domain Name ?'
Get-ADDomain -Identity $Domain | Select-Object ReplicaDirectoryServers,ReadOnlyReplicaDirectoryServer

# ----------
# Replication
## List inbound replication partners for domain controller ##
Get-ADReplicationPartnerMetadata -Target 'REBEL-SDC01.rebeladmin.com'
...
Get-ADReplicationFailure -Target 'REBEL-SDC01.rebeladmin.com'
...
$c | Select-Object Name,SiteLinksIncluded | Format-List

## ------------------------------------------------------------------------------ ##
## List down Subnet Information ##
$d = (Get-ADReplicationSubnet -Filter * | Select-Object Name,Site)
...
"@
$failedevent = Get-Eventlog security -Computer $dc -InstanceId 4625 -After (Get-Date).AddDays(-7) | Select-Object TimeGenerated,ReplacementStrings |
ForEach-Object {
...
$failedevent | ConvertTo-Html -Property SourceComputer,UserName,SourceIPAddress,Date -head $HTML -body "<H2>Failed Login Report for $dc</H2>" | Out-File $Report
...
$passwordreport = $null
$dc = (Get-ADDomain | Select-Object DNSRoot).DNSRoot
...
"@
$enterpiseadmins = Get-ADGroupMember -Identity "Enterprise Admins" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>Enterprise Admins</h2>"
$schemaadmins = Get-ADGroupMember -Identity "Schema Admins" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>Schema Admins</h2>"
$domainadmins = Get-ADGroupMember -Identity "Domain Admins" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>Domain Admins</h2>" 
$accountoperators = Get-ADGroupMember -Identity "Account Operators" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>Account Operators</h2>" 
$serveroperators = Get-ADGroupMember -Identity "Server Operators" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>Server Operators</h2>"
$printoperators = Get-ADGroupMember -Identity "Print Operators" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>Print Operators</h2>"
$dnsadmins = Get-ADGroupMember -Identity "DnsAdmins" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>DNS Admins</h2>"
...
"@
$enterpiseadmins = Get-ADGroupMember -Identity "Enterprise Admins" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Where-Object {$_.LastLogonDate -le $30Days}| Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>Enterprise Admins</h2>"
$schemaadmins = Get-ADGroupMember -Identity "Schema Admins" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Where-Object {$_.LastLogonDate -le $30Days}| Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>Schema Admins</h2>"
$domainadmins = Get-ADGroupMember -Identity "Domain Admins" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Where-Object {$_.LastLogonDate -le $30Days}| Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>Domain Admins</h2>" 
$accountoperators = Get-ADGroupMember -Identity "Account Operators" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Where-Object {$_.LastLogonDate -le $30Days}| Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>Account Operators</h2>" 
$serveroperators = Get-ADGroupMember -Identity "Server Operators" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Where-Object {$_.LastLogonDate -le $30Days}| Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>Server Operators</h2>"
$printoperators = Get-ADGroupMember -Identity "Print Operators" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Where-Object {$_.LastLogonDate -le $30Days}| Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>Print Operators</h2>"
$dnsadmins = Get-ADGroupMember -Identity "DnsAdmins" | Where-Object {$_.objectclass -eq 'user'} | Get-ADUser -Properties LastLogonDate | Where-Object {$_.LastLogonDate -le $30Days}| Select-Object Name,LastLogonDate | ConvertTo-Html -Property "Name","LastLogonDate" -Fragment -PreContent "<h2>DNS Admins</h2>"
$Reportvalues = ConvertTo-HTML -Body "$enterpiseadmins $schemaadmins $domainadmins $accountoperators $serveroperators $printoperators $dnsadmins" -Head $HTML
...
"@
$disabledaccounts = Get-ADUser -Filter {Enabled -eq $false} | Select-Object samAccountName,GivenName,Surname | ConvertTo-Html -Property "samAccountName","GivenName","Surname" -Fragment -PreContent "<h2>Disabled Account</h2>"
$inactiveaccounts = Get-ADUser -Filter {LastLogonDate -lt $InactiveDate -and Enabled -eq $true} -Properties LastLogonDate | Select-Object samAccountName,GivenName,Surname,LastLogonDate | ConvertTo-Html -Property "samAccountName","GivenName","Surname","LastLogonDate" -Fragment -PreContent "<h2>Inactive Accounts</h2>"
...
Get-ADUser -Filter  { passwordNeverExpires -eq $true -and Enabled -eq $true } -Properties * | Select-Object samAccountName,GivenName,Surname
...
Get-AzureADDomainVerificationDnsRecord -Name M365x562652.onmicrosoft.com | Format-List

## List tenant details ##
Get-AzureADTenantDetail | Format-List

## Last sync time ##
Get-AzureADTenantDetail | Select-Object CompanyLastDirSyncTime

# Managing users
## User details ##
Get-AzureADUser -ObjectId AdeleV@M365x562652.OnMicrosoft.com | Format-List
...
Get-AzureADUser -All $true -Filter 'accountEnabled eq false' | Select-Object DisplayName,UserPrincipalName,Department

## Synced users ##
Get-AzureADUser -All $true -Filter 'DirSyncEnabled eq true'

## Last sync value ##
Get-AzureADUser -All $true -Filter 'DirSyncEnabled eq true' | Select-Object DisplayName,UserPrincipalName,LastDirSyncTime

## Export filtered data to CSV ##
Get-AzureADUser -All $true -Filter 'DirSyncEnabled eq true' | Select-Object DisplayName,UserPrincipalName,LastDirSyncTime | Export-CSV -Path .\syncaccount.csv

## immutableid value null ##
Get-AzureADUser -All $true | where-Object {$_.ImmutableId -eq $null}

## Export filtered data to CSV ##
Get-AzureADUser -All $true | where-Object {$_.ImmutableId -eq $null} | Select-Object DisplayName,UserPrincipalName | Export-CSV -Path .\cloudaccount.csv

## Licence associated with account ##
Get-AzureADUserLicenseDetail -ObjectId MeganB@M365x562652.OnMicrosoft.com | Format-List
...
Get-AzureADUserLicenseDetail -ObjectId ADJellison@M365x562652.onmicrosoft.com | Format-List
...
$notlicenced = Get-AzureADUser -All $true | Where-Object {$ADusers.AssignedLicenses -ne $null} | Select-Object ObjectId | Out-File -FilePath C:\users.txt
#####Set UsageLocation value to sync users#########
(Get-Content "C:\users.txt" | Select-Object -Skip 3) | ForEach-Object { Set-AzureADUser -ObjectId $_ -UsageLocation "US" }
#####Set User Licecnes############
...
(Get-Content "C:\users.txt" | Select-Object -Skip 3) | ForEach-Object { Set-AzureADUserLicense -ObjectId $_ -AssignedLicenses $newlicenceadd }
...
$Userpassword = New-Object -TypeName Microsoft.Open.AzureAD.Model.PasswordProfile
$Userpassword.Password = "London@1234"
Import-Csv -Path C:\newuser.csv | ForEach-Object {New-AzureADUser -UserPrincipalName $_.UserPrincipalName -DisplayName $_.DisplayName -MailNickName $_.MailNickName -PasswordProfile $Userpassword -AccountEnabled $true}
...
$Userpassword = New-Object -TypeName Microsoft.Open.AzureAD.Model.PasswordProfile
$Userpassword.Password = "London@1234"
Import-Csv -Path C:\newuser.csv | ForEach-Object {New-AzureADUser -UserPrincipalName $_.UserPrincipalName -DisplayName $_.DisplayName -MailNickName $_.MailNickName -PasswordProfile $Userpassword -UsageLocation "US" -AccountEnabled $true} | Select-Object ObjectId | Out-File -FilePath C:\users.txt
###########Assign Licences#################
$newlicence = New-Object -TypeName Microsoft.Open.AzureAD.Model.AssignedLicense
$newlicenceadd = New-Object -TypeName Microsoft.Open.AzureAD.Model.AssignedLicenses
$newlicence.SkuId = (Get-AzureADSubscribedSku | Where-Object -Property SkuPartNumber -Value "ENTERPRISEPREMIUM" -EQ).SkuId
...
## Synced user groups ##
Get-AzureADGroup -Filter 'DirSyncEnabled eq true' | Select-Object ObjectId,DisplayName,LastDirSyncTime
...
Get-AzureADUser -All $true -Filter "Department eq 'Marketing'" | Select-Object ObjectId | Out-File -FilePath C:\salesusers.txt
#####Add Users to Sales Group#########
(Get-Content "C:\salesusers.txt" | Select-Object -skip 3) | ForEach-Object { Add-AzureADGroupMember -ObjectId f9f51d29-e093-4e57-ad79-2fc5ae3517db -RefObjectId $_ }
